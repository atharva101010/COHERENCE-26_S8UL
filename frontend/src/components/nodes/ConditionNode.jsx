...
export default function ConditionNode({ data, selected }) {
  return (
    <div className={`px-4 py-3 rounded-xl border-2 min-w-[180px] shadow-md transition-all
      ${selected ? 'border-orange-500 shadow-orange-200 dark:shadow-orange-900/20 ring-2 ring-orange-300' : 'border-orange-300 dark:border-orange-700/50'}
      bg-gradient-to-br from-orange-50 to-rose-100 dark:from-orange-950/30 dark:to-rose-900/30`}>
      ...
      <div className="flex items-center gap-2">
        ...
        <div>
          <div className="text-xs font-medium text-orange-600 dark:text-orange-400 uppercase tracking-wide">Condition</div>
          <div className="text-sm font-semibold text-orange-900 dark:text-orange-100">{data.label || 'Condition'}</div>
        </div>
      </div>
      {data.field && (
        <div className="mt-2 text-xs text-orange-700 dark:text-orange-300 bg-orange-200/50 dark:bg-orange-800/40 px-2 py-0.5 rounded-full w-fit">
