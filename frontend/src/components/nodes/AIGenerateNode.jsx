  ...
  return (
    <div className={`px-4 py-3 rounded-xl border-2 min-w-[180px] shadow-md transition-all
      ...
      <div className="flex items-center gap-2">
        ...
        <div>
          <div className="text-xs font-medium text-violet-600 dark:text-violet-400 uppercase tracking-wide">AI Generate</div>
          <div className="text-sm font-semibold text-violet-900 dark:text-violet-100">{data.label || 'AI Generate'}</div>
        </div>
      </div>
      {data.tone && (
